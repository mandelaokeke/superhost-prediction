...
This project estimates whether a New York City listing row belongs to the current Superhost class. The current champion is a histogram gradient-boosting classifier trained and evaluated with host-disjoint data splits.
